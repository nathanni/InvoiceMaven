...
public class Header {
  ...
  public String toString() {
    return "Header [invoice=" + invoice + ", invoiceDate=" + invoiceDate + ", cashDiscPct=" + cashDiscPct
        + ", discTerms=" + discTerms + ", netTerms=" + netTerms + ", purchaseOrder=" + purchaseOrder + ", salesOrder="
        + salesOrder + ", billOfLading=" + billOfLading + ", howShip=" + howShip + ", fob=" + fob + ", jobName="
        + jobName + ", approvalNeeded=" + approvalNeeded + ", approvalCode=" + approvalCode + ", customerCode="
        + customerCode + ", shipToAddr1=" + shipToAddr1 + ", shipToAddr2=" + shipToAddr2 + ", shipToAddr3="
        + shipToAddr3 + ", shipToAddr4=" + shipToAddr4 + ", shipToAddr5=" + shipToAddr5 + ", shipToAddr6=" + shipToAddr6
        + ", soldToAddr1=" + soldToAddr1 + ", soldToAddr2=" + soldToAddr2 + ", soldToAddr3=" + soldToAddr3
        + ", soldToAddr4=" + soldToAddr4 + ", soldToAddr5=" + soldToAddr5 + ", soldToAddr6=" + soldToAddr6
