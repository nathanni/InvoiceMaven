...
public class Line {
  ...
  //constructor for building configLine
  public Line(int orderQty, int shippedQty, String lineDesc) {
    super();
    this.orderQty = orderQty;
    this.shippedQty = shippedQty;
    this.lineDesc = lineDesc;
  ...
  public String toString() {
    return "Line [lineTypeId=" + lineTypeId + ", muType=" + muType + ", seqNo=" + seqNo + ", partNumber=" + partNumber
        + ", partDesc=" + partDesc + ", skuNumber=" + skuNumber + ", unitPrice=" + unitPrice + ", extensionPrice="
        + extensionPrice + ", discount=" + discount + ", orderQty=" + orderQty + ", shippedQty=" + shippedQty
        + ", itemId=" + itemId + ", unitId=" + unitId + ", lineDesc=" + lineDesc + ", l1Desc=" + l1Desc + ", l2Desc="
        + l2Desc + ", sizeCode=" + sizeCode + ", size=" + size + ", sizeNS=" + sizeNS + ", sizeES=" + sizeES + "]";
  }
